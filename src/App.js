...
import HobbiesScreen from "./views/Hobbies/Hobbies";
import ImgsScreen from "./views/Imgs/Imgs";
    ...
    >
      <Router>
        ...
        <Switch>
          ...
          <Route path="/hobbies" component={HobbiesScreen} />
          <Route path="/imgs" component={ImgsScreen} />
